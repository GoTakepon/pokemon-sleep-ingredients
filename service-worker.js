...
const CACHE_NAME = "psleep-cache-20251030-1110";

// ★ データ用のバージョン（update-version.js が自動更新）
const VERSION = "20251030-1110";
...
const STATIC_ASSETS = [
  ...
  "./assets/css/base.css?v=20251030-1110",
  "./assets/css/custom.css?v=20251030-1110",
  "./assets/css/section-ocr.css?v=20251030-1110",
  "./assets/css/section-goal.css?v=20251030-1110",
  "./assets/css/section-ingrediants.css?v=20251030-1110",
  "./assets/css/section-recommend.css?v=20251030-1110",
  "./assets/css/theme-yadon.css?v=20251030-1110",
  "./assets/icon-192.png",
  "./assets/icon-512.png",
];
